...
@Component({
  selector: 'app-create-request-place',
  templateUrl: './create-request-place.page.html',
  styleUrls: ['./create-request-place.page.scss'],
})
export class CreateRequestPlacePage implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder,
    private lugarS: RequestCreateService,
  ...
  public async sendForm() {
    ...
    this.lugarS.agregaSolicitud(data)
      .then((respuesta) => {
  ...
  camara() {
    ...
    this.camera.getPicture(options).then((imageData) => {
      ...
      this.saveImageFirebaseStorage("placesRequestImage/", id, this.tempImg);
